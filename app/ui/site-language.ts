...
const EN_DICTIONARY: LanguageDictionary = {
  ...
  "Tableau de bord pro pour entreprises visibles": "Professional dashboard for visible companies",
  ...
  "Une experience SaaS claire pour trouver une entreprise, comparer les offres disponibles et transformer chaque fiche en point de contact qualifie.": "A clear SaaS experience to find a company, compare available jobs and turn every profile into a qualified contact point.",
  ...
  "Navigation laterale sur mobile et desktop": "Sidebar navigation on mobile and desktop",
  ...
  "Plateforme orientee business: centralisez la decouverte, la recherche, les categories et les candidatures dans une interface plus dense, lisible et professionnelle.": "Business-focused platform: centralize discovery, search, categories and applications in a denser, readable and professional interface.",
  "Medias secondaires": "Secondary media",
  "Parcourez les espaces de promotion, les formations et les services utiles pour renforcer la presence digitale de votre entreprise sans quitter le parcours principal.": "Browse promotion spaces, training and useful services to strengthen your company's digital presence without leaving the main journey.",
  "defilement automatique": "auto scrolling",
  "Recherche instantanee": "Instant search",
  Filtres: "Filters",
  "Parametres de filtre": "Filter settings",
  "Fermer les filtres": "Close filters",
  Supprimer: "Clear",
  Appliquer: "Apply",
  "Recherchez une entreprise, un service ou une offre depuis un seul espace. Combinez mot cle, categorie et ville pour obtenir rapidement des resultats exploitables.": "Search for a company, service or job from one space. Combine keyword, category and city to quickly get actionable results.",
  ...
  "Explorez les offres disponibles et identifiez les opportunites les plus pertinentes selon le poste, la ville, le type de contrat et l entreprise qui recrute.": "Explore available jobs and identify the most relevant opportunities by role, city, contract type and hiring company.",
  ...
  "Parcourez les secteurs disponibles pour comprendre le paysage des entreprises, comparer les acteurs par domaine et ouvrir directement les fiches les plus utiles.": "Browse available sectors to understand the company landscape, compare players by field and open the most useful profiles directly.",
  ...
  "Navigation laterale": "Sidebar navigation",
...
const AR_DICTIONARY: LanguageDictionary = {
  ...
  "Tableau de bord pro pour entreprises visibles": "لوحة تحكم احترافية لشركات أكثر ظهورا",
  ...
  "Une experience SaaS claire pour trouver une entreprise, comparer les offres disponibles et transformer chaque fiche en point de contact qualifie.": "تجربة SaaS واضحة للعثور على الشركات ومقارنة العروض المتاحة وتحويل كل بطاقة إلى نقطة تواصل مؤهلة.",
  ...
  "Navigation laterale sur mobile et desktop": "شريط جانبي على الجوال وسطح المكتب",
  ...
  "Plateforme orientee business: centralisez la decouverte, la recherche, les categories et les candidatures dans une interface plus dense, lisible et professionnelle.": "منصة موجهة للأعمال تجمع الاكتشاف والبحث والفئات والترشيحات في واجهة أكثر كثافة ووضوحا واحترافية.",
  "Medias secondaires": "وسائط ثانوية",
  "Parcourez les espaces de promotion, les formations et les services utiles pour renforcer la presence digitale de votre entreprise sans quitter le parcours principal.": "تصفح مساحات الترويج والتدريب والخدمات المفيدة لتعزيز حضور شركتك الرقمي دون مغادرة المسار الرئيسي.",
  "defilement automatique": "تمرير تلقائي",
  "Recherche instantanee": "بحث فوري",
  Filtres: "فلاتر",
  "Parametres de filtre": "إعدادات الفلترة",
  "Fermer les filtres": "إغلاق الفلاتر",
  Supprimer: "مسح",
  Appliquer: "تطبيق",
  "Recherchez une entreprise, un service ou une offre depuis un seul espace. Combinez mot cle, categorie et ville pour obtenir rapidement des resultats exploitables.": "ابحث عن شركة أو خدمة أو عرض من مساحة واحدة. اجمع بين الكلمة المفتاحية والفئة والمدينة للحصول بسرعة على نتائج قابلة للاستخدام.",
  ...
  "Explorez les offres disponibles et identifiez les opportunites les plus pertinentes selon le poste, la ville, le type de contrat et l entreprise qui recrute.": "استكشف العروض المتاحة وحدد الفرص الأنسب حسب المنصب والمدينة ونوع العقد والشركة التي توظف.",
  "Voir moins": "عرض أقل",
  ...
  "Parcourez les secteurs disponibles pour comprendre le paysage des entreprises, comparer les acteurs par domaine et ouvrir directement les fiches les plus utiles.": "تصفح القطاعات المتاحة لفهم مشهد الشركات ومقارنة الفاعلين حسب المجال وفتح البطاقات الأكثر فائدة مباشرة.",
  ...
  Navigation: "التنقل",
  "Navigation laterale": "شريط جانبي",
  Categories: "الفئات",
